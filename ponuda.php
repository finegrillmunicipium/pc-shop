...
<body>
  ...
  <div class="container-searchbar">
    <form action="#" method="post" class="search-bar" target="_blank">
      <input type="search" placeholder="Pretraži ponudu" name="q">
  ...
  <section class="interior-section-two menu-section">
    <div class="menu-list menu-list__dotted menu-list-1">
      ...
      <ul class="menu-list__items">
        <?php
                $sql = "SELECT * FROM tbl_ponuda WHERE aktivno = 'Da'";
