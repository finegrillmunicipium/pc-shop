...
<body>
    ...
    <form action="" method="POST">
        <div class="text-input">
            ...
            <input type="text" name="imeprezime" placeholder="Unesite ime i prezime" value=<?php echo $ime_prezime; ?>>
        </div>
        <div class="text-input">
            <label>Korisničko ime:</label>
            <input type="text" name="korisnickoime" placeholder="Unesite korisničko ime" value=<?php echo $korisnicko_ime; ?>>
        </div>
        <input type="hidden" name="id" value=<?php echo $id; ?>>
        <input style="width: 150px" type="submit" name="submit" value="Izmijeni admina" class="center">
    </form>
...
if (isset($_POST['submit'])) {
    ...
    if ($rezultat == TRUE) {
        $_SESSION['admin_updated'] = 'Uspješno ste izmijenili admina!';
        header('location:http://localhost/pcshop/admin/manage-admin.php');
    } else {
        $_SESSION['admin_updated'] = 'Greška! Niste uspjeli izmijeniti admina.';
