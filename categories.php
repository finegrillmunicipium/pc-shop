...
<head>
  ...
  <title>PC Arena | Istraži kategorije</title>
...
<body>
  ...
  <section class="categories">
    <div class="container">
      <h2 class="text-center">Istraži kategorije</h2>
      <div class="row">
        <?php
                ...
                ?>
        <div class="col-sm-4">
          <a href="categories-ponuda.php?kategorija_id=<?php echo $id; ?>">
            <div class="box-3 float-container">
              <img src="images/<?php echo $foto_naziv; ?>" alt="" class="img-responsive img-curve">
              <h3 class="float-text">
                <?php echo $naziv; ?>
              </h3>
            </div>
